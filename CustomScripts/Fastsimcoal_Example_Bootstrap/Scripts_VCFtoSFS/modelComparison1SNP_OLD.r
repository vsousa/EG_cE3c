...
settings <- list()
# model tags
# settings$modeltag <- c("A_Hybrid","B_noadm_CT","B_noadm_CT_NOBOT","C_noadm_TG","C_noadm_TG_NOBOT","D_Hybrid","E_SC_TG","F_SC_CT")
# settings$modeltag <- c("B_noadm_CT_NOBOT","C_noadm_TG_NOBOT")
# settings$modeltag <- c("A_Hybrid","B_noadm_CT","B_noadm_CT_NOBOT","C_noadm_TG","C_noadm_TG_NOBOT")
# settings$modeltag <- c("A_Hybrid","B_noadm_CT_NOBOT","C_noadm_TG_NOBOT")
settings$modeltag <- c("D_Hybrid","E_SC_TG","F_SC_CT")
# model population tag 
# settings$poptag <- c("COCRCANPs","COCRCANPs","COCRCANPs","COCRCANPs","COCRCANPs","COCRCANPs","COCRCANPs","COCRCANPs")
# settings$poptag <- c("COCRCANPs","COCRCANPs","COCRCANPs")
settings$poptag <- c("COCRCANPs","COCRCANPs","COCRCANPs")
# model code - the name of each model is given by poptag-code 
# settings$code <- c("a_ncm", "NoMig", "NoMig", "NoMig_TG", "NoMig_TG", "a_ncm_hs","a_sc_ct","a_sc_gt")
# settings$code <- c("a_ncm", "NoMig", "NoMig_TG")
# settings$code <- c("a_ncm", "NoMig","NoMig", "NoMig_TG","NoMig_TG")
settings$code <- c("a_ncm_hs","a_sc_ct","a_sc_gt")
# number of parameters of each model
# settings$nparam <- c(8, 8, 7, 8, 7, 9, 9, 9)
# settings$nparam <- c(8, 7, 7)
...
# settings$pathmaxpar <- rep("MaxParFiles/inds_3_4_3", times=length(settings$poptag))
# settings$pathmaxpar <- rep("MaxParFiles/inds_2_3_2", times=length(settings$poptag))
settings$pathmaxpar <- rep("MaxParFiles/inds_1_2_1", times=length(settings$poptag))
# settings$pathmaxpar <- c("../../FSC_results_manuscript_08_07_2020/best_runs_02_06_2020/A_Admixture/run8",
#                          "../../FSC_results_manuscript_08_07_2020/best_runs_02_06_2020/B_No_Admixture_CT/run9",
#                          "../../FSC_results_manuscript_08_07_2020/best_runs_02_06_2020/C_No_Admixture_TG/run4",
#                          "../../FSC_results_manuscript_08_07_2020/best_runs_02_06_2020/D_HybridSpeciation/run38",
...
# settings$bootpath <- paste("./block_SFS_200bp_dist2_ind2_3_2/Bootstrap_1SNP_200bp_dist2_ind2_3_2/jsfs",sep="")
settings$bootpath <- paste("./block_SFS_200bp_dist2_ind1_2_1/Bootstrap_1SNP_200bp_dist2_ind1_2_1/jsfs",sep="")
# settings$bootpath <- paste("./block_SFS_200bp_dist2_ind3_4_3/Bootstrap_1SNP_200bp_dist2_ind3_4_3/jsfs",sep="")
# settings$bootpath <- paste("./block_SFS_200bp_dist2_ind3_4_3/Bootstrap_200bp_dist2_ind3_4_3/jsfs",sep="")
# tag for observed SFS file 
# settings$bootfile <- paste("sfs_1snp_200bp_dist2_ind2_3_2_boot_nm_MSFS",sep="")
settings$bootfile <- paste("sfs_1snp_200bp_dist2_ind1_2_1_boot_nm_MSFS",sep="")
# settings$bootfile <- paste("sfs_1snp_200bp_dist2_ind3_4_3_boot_nm_MSFS",sep="")
# settings$bootfile <- paste("sfs_200bp_dist2_ind3_4_3_boot_nm_MSFS",sep="")

# number of bootstrap replicates
settings$nboot <- 1000
# path to observed SFS multisfs
# settings$obsfile <- paste("./block_SFS_200bp_dist2_ind2_3_2/SFS_200bp_dist2_ind2_3_2/200bp_dist2_ind2_3_2_MAF_nomon_DSFS.obs")
settings$obsfile <- paste("./block_SFS_200bp_dist2_ind1_2_1/SFS_200bp_dist2_ind1_2_1/200bp_dist2_ind1_2_1_MAF_nomon_DSFS.obs")
# settings$obsfile <- paste("./block_SFS_200bp_dist2_ind3_4_3/SFS_200bp_dist2_ind3_4_3/200bp_dist2_ind3_4_3_MAF_nomon_DSFS.obs")
...
folderSaveSFS <- "ExpectedMultiSFS_121"
